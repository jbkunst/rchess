...
`rchess` provides chess move generation and validation, piece placement
and movement, game-state inspection, and board visualization from R. It
...
website](https://jkunst.com/rchess/). The site uses this Markdown
document as its home page, so GitHub and the package documentation stay
aligned.

## Development

Issues and pull requests are welcome in the [GitHub
repository](https://github.com/jbkunst/rchess).
