...
Or a ggplot2 version (I know, we need to change the [chess pieces symbols in unicode](https://en.wikipedia.org/wiki/Chess_symbols_in_Unicode); maybe use a chess typeface)
...
##  [9] stringr_1.0.0    plyr_1.8.3       dplyr_0.4.3      tools_3.2.0     
## [13] parallel_3.2.0   grid_3.2.0       gtable_0.1.2     DBI_0.3.1       
## [17] ggthemes_2.2.1   htmltools_0.2.6  yaml_2.1.13      lazyeval_0.1.10 
## [21] assertthat_0.1   digest_0.6.8     reshape2_1.4.1   ggplot2_1.0.1   
